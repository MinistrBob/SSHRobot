...
if success > 0:
    print(f"The commands was executed successfully on {success}/{total}={round(success*100/total)}% servers:")
...
if error_c > 0:
    ...
    for i in list_error_connect:
        print(f"    {i}")
if error_e > 0:
    print(f"Failed to connect to {error_e}/{total}={round(error_e*100/total)}% servers:")
